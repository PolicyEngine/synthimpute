...
def test_ols_impute():
    ...
    base = si.ols_impute(x_train, y_train, x_test)
    # Try with some args.
    si.ols_impute(x_train, y_train, x_test, random_state=10, n_estimators=200)
    ...
    higher_q = si.ols_impute(x_train, y_train, x_test, mean_quantile=0.9)
